...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)('my-plugin/latest-dflip', {
  title: 'Latest DFlip Post',
  icon: 'book-alt',
  category: 'widgets',
  edit: () => {
    const latestPost = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(select => {
